...
bd-portfolio.sh --filter "my-project-*"
...
bd-portfolio.sh skeletons my-project
```
...
Active: project-alpha, project-beta
Ready: project-gamma, project-delta
Stalled: project-epsilon, project-zeta
...
ACTIVE (work in progress):
  project-alpha: 1 in_progress, 10 ready
  project-beta: 1 in_progress, 5 ready

READY (P1-P2 work available):
  project-gamma: P1=0 P2=5 (5 ready)

STALLED (P3 only):
  project-epsilon: 6 open (all P3)

DORMANT (all closed):
  project-zeta: 6 closed

QUALITY ISSUES (skeleton beads):
  project-eta: 12 empty shells
```
...
Output:
```
Skeleton beads in my-project:
  [2] my-project-abc: Implement feature X
  [2] my-project-def: Refactor component Y
  [3] my-project-ghi: Upgrade strategy
```
