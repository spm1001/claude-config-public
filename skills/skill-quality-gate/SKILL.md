...
description: MANDATORY quality gate before writing any SKILL.md file. Invoke this skill FIRST when building new skills - provides naming conventions, description requirements, and quality checklist that MUST be validated before deployment. Complements skill-creator (process) with validation (requirements). Triggers on 'build skill', 'create skill', 'write SKILL.md', or when planning to create ~/.claude/skills/*/SKILL.md files.
---
...
```yaml
description: Coach on outcome quality with Tier 2 vs Tier 3 distinction. Triggers on 'check my outcomes', 'is this a good outcome', 'review my tasks', 'why isn't this working' when discussing strategic work vs tactical projects.
```
...
Why bad:
- Too generic (Claude "knows" patterns without invoking)
- No timing gate
- No method preview
...
- Exoskeleton intervention points
...
**Validation (skill-quality-gate):** What quality to meet
